	...
	, cancel(false)
{
	...
	// Identify as BambuStudio so Bambu's cloud doesn't reject the request as a third-party client.
	::curl_easy_setopt(curl, CURLOPT_USERAGENT, "BambuStudio/" SoftFever_VERSION);
